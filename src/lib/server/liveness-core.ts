// src/lib/server/liveness-core.ts
//
// Pure liveness classifier — implementation inlined from liveness-core.mjs.
// Used by check-liveness CLI and the Next.js API route.

export type LivenessResult = 'expired' | 'active' | 'uncertain';
