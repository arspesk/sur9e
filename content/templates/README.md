...
System-layer template files used by sur9e scripts and modes. These files are auto-updated when you run `npm run update:apply` -- put user customizations in the user-layer files instead (see DATA_CONTRACT.md).
...
node generate-latex.mjs artifacts/output/cv-name-company-date.tex

# Or specify a custom output path
node generate-latex.mjs artifacts/output/cv-name-company-date.tex artifacts/output/custom-name.pdf
```
...
**Customization:** Edit this file to change margins, section order, or formatting commands. The placeholder tokens are documented in `content/modes/latex.md` under "Template Placeholders."
