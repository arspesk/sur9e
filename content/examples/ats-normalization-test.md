...
The normalizer does NOT fix writing style. These are enforced by the rules in `content/modes/_shared.md` and should never appear in generated CV text in the first place.
