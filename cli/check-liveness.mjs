 ...
 * Detects closed/dead postings (404/410, "no longer accepting", an expired
 * banner, or a hard redirect to a generic careers page) — the same signals
 * the evaluate/evaluate-offer liveness gate uses.
...
import { classifyLiveness } from '../src/lib/server/liveness-core.js';
